<div>
    ...
    <form method="post" class="max-w-sm mx-auto">
        ...
        <div class="flex flex-row justify-around">
            <button type="submit" class="py-3 px-2 rounded-lg bg-font text-primary border border-primary hover:bg-primary hover:text-font ease-in-out duration-500">Sign up</button>
        </div>
    </form>
</div>